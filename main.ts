export class InMemoryBus<Events extends { [event: string]: any }> {
   ...
   * @returns {void}
   */
  public on<T extends keyof Events>(event: T, callback: (data: Events[T]) => void): void {
   ...
   * @returns {void}
   */
  public off<T extends keyof Events>(event: T, callback: (data: Events[T]) => void): void {
   ...
   * @returns {void}
   */
  public once<T extends keyof Events>(event: T, callback: (data: Events[T]) => void): void {
   ...
   */
  public getListeners<T extends keyof Events>(event: T): Set<Function> | undefined {
